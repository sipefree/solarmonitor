<?
	...
	*/
	...
	include ("/Users/solmon/Sites/write_ar_table.php");
	include ("/Users/solmon/Sites/write_title.php");
	include ("/Users/solmon/Sites/write_bottom.php");
	include ("/Users/solmon/Sites/write_left.php");
	include ("/Users/solmon/Sites/write_right.php");
	include ("/Users/solmon/Sites/write_footer.php");
	include ("/Users/solmon/Sites/write_header.php");
	include ("/Users/solmon/Sites/write_jscript.php");
	include ("/Users/solmon/Sites/write_statcounter.php");
	include ("/Users/solmon/Sites/write_googleanalytics.php");
	...
	//if ($this_page == "index.php") include ("/Users/solmon/Sites/write_index_body.php");
	//if ($this_page == "index2.php") include ("/Users/solmon/Sites/write_index_body2.php");
	if ($this_page != "search.php") 
		if ($this_page != "region.php")
			include ("/Users/solmon/Sites/write_index_body.php");
	include ("/Users/solmon/Sites/write_events.php");
	include ("/Users/solmon/Sites/write_image_map.php");
	include ("/Users/solmon/Sites/write_region_body.php");
	
	//	include the generic functions and arrays that may be needed by anything
	include ("/Users/solmon/Sites/globals.php");
	include ("/Users/solmon/Sites/functions.php");
	include ("/Users/solmon/Sites/bakeout.php");
	include ("/Users/solmon/Sites/scrape_functions.php");

<?
	...
	*/
	...
	function write_title($date, $title, $this_page, $type=NULL, $width=780, $region=NULL)
	{
		...
		print("			<font size=2>&lArr;</font><a class=mail3 href =\"./$this_page?date=${prev_day}${type_str}${region_str}\"><i>$prev_day</i></a>\n");
		print("			<font size=2>&lArr;</font><a class=mail3 href =\"./$this_page?date=${prev_week}${type_str}${region_str}\"><i>Week</i></a>\n");
		print("			<font size=2>&lArr;</font><a class=mail3 href =\"./$this_page?date=${prev_rot}${type_str}${region_str}\"><i>Rotation</i></a>\n");
		print("		</b></font></td>\n");
		//print("		</td>\n");
		...
		print("			<a class=mail3 href =\"./$this_page?date=${next_rot}${type_str}${region_str}\"><i>Rotation</i></a><font size=2>&rArr;</font>\n");
		print("			<a class=mail3 href =\"./$this_page?date=${next_week}${type_str}${region_str}\"><i>Week</i></a><font size=2>&rArr;</font>\n");    
		print("			<a class=mail3 href =\"./$this_page?date=${next_day}${type_str}${region_str}\"><i>$next_day</i></a><font size=2>&rArr;</font>\n");  
		print("		</b></font></td>\n");
		//print("		</td>\n");
		print("	</tr>\n");
		print("</table>\n");

<?
	...
	*/
	...
	function write_events($date)
	{
			...
			else
			{
				...
				foreach($lines as $line)
				{
					...
					else
					{
						...
						print("<a class=mail href=javascript:OpenLastEvents(\"$url\")>$data</a>");
					}	
				}
			}
		}
		...
		print("				<p><i><b>Note:</b></i> The tabulated data are based on the most recent NOAA/USAF Active Region Summary issued on $time1, the values to the right of the forward slashes representing yesterdays values or events.	The region positions are valid on $time2.\n");
		print("				</font></td>\n");
		print("			</tr>\n");
		print("		</table>\n");
	}
